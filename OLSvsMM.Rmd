...
dataMod$variable = recode_factor(dataMod$variable, 
              "0.5_0.5"="gamma==0.5 ~ ';' ~ Sigma == 0.5",
              "0.5_5"="gamma == 0.5 ~ ';' ~ Sigma == 5","0.5_10"="gamma == 0.5 ~ ';' ~ Sigma == 10",
              "0.5_20"="gamma == 0.5 ~ ';' ~ Sigma == 20",
              "2_0.5"="gamma == 2 ~ ';' ~ Sigma == 0.5", "2_5"="gamma == 2 ~ ';' ~ Sigma == 5",
              "2_10"="gamma == 2 ~ ';' ~ Sigma == 10",
              "2_20"="gamma == 2 ~ ';' ~ Sigma == 20","5_0.5"="gamma == 5 ~ ';' ~ Sigma == 0.5",
              "5_5"="gamma == 5 ~ ';' ~ Sigma == 5","5_10"="gamma == 5 ~ ';' ~ Sigma == 10",
              "5_20"="gamma == 5 ~ ';' ~ Sigma == 20",
              "10_0.5"="gamma == 10 ~ ';' ~ Sigma == 0.5",
              "10_5"="gamma == 10 ~ ';' ~ Sigma == 5","10_10"="gamma == 10 ~ ';' ~ Sigma == 10",
              "10_20"="gamma == 10 ~ ';' ~ Sigma == 20")
