...
\hline \\[-1.8ex] 
$\gamma\ne0$& `r round(betaLm['X'], 4)` &  `r round(SE, 4)`\\ 
$\gamma=0$& `r round(betaLm.1['X'], 4)` &  `r round(SE.1, 4)`\\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table} 
...
\hline \\[-1.8ex] 
 & $\hat{\beta}$ & $SE(\hat{\beta})$\\ 
\hline \\[-1.8ex] 
$\gamma\ne0$& `r round(betaLmer['X'], 4)` &  `r round(SE, 4)`\\ 
$\gamma=0$& `r round(betaLmer.1['X'], 4)` &  `r round(SE.1, 4)`\\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table} 
...
\hline \\[-1.8ex] 
 & $\hat{\beta}$ & $SE(\hat{\beta})$ \\ 
\hline \\[-1.8ex] 
$\gamma\ne0$& `r round(res$betaOLS, 4)` &  `r round(res$SE, 4)` \\ 
$\gamma=0$& `r round(res.1$betaOLS, 4)` &  `r round(res.1$SE, 4)`\\ 
\hline \\[-1.8ex] 
\end{tabular} 
\end{table} 
