...
```{r, fig.width=12, fig.height=6, fig.fullwidth=TRUE}
ccdfRes <- data.frame(ccdfWith =c(0.004 ,-0.0446, -0.1584, -0.2611, -0.3738, -0.3058, -0.1823,-0.1249, -0.0907, -0.0198),
                      mixedWith =c(-0.004 ,-0.044, -0.1577, -0.2563, -0.3806, -0.3241, -0.2114, -0.1515, -0.1037, -0.0223),
                      ccdfWithout = c(-0.004, -0.03644, -0.1781, -0.4295, -0.6163, -0.6804, -0.5527, -0.2844, -0.1106, -0.0237),
                      mixedWithout = c(-0.0041, -0.0369, -0.1785, -0.4295, -0.6163,-0.6804, -0.5527, -0.2844, -0.1081, -0.0237),
                      indBeta = 1:10)

ccdfRes <- melt(ccdfRes, id.vars="indBeta",value.name = "Estimate",variable.name = "Model")
