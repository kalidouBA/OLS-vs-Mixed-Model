...
{\begin{tabular}{@{\extracolsep{4pt}}llcccccccccccc}
\toprule   
{} & {}  & \multicolumn{3}{c}{$\boldsymbol{OLS_{\gamma\ne0}}$}  & \multicolumn{3}{c}{$\boldsymbol{OLS_{\gamma=0}}$} & \multicolumn{3}{c}{$\boldsymbol{MM_{\gamma\ne0}}$}\\
 
 \cmidrule{3-5} 
 \cmidrule{6-8} 
 \cmidrule{9-11}  
 $\boldsymbol{\beta}$&$\boldsymbol{\Sigma}$ & $\boldsymbol{\hat\beta}$ & $\boldsymbol{SE(\hat\beta)}$ & $\boldsymbol{\sigma(\hat\beta)}$ &  $\boldsymbol{\hat\beta}$ & $\boldsymbol{SE(\hat\beta)}$ & $\boldsymbol{\sigma(\hat\beta)}$ &  $\boldsymbol{\hat\beta}$ & $\boldsymbol{SE(\hat\beta)}$ & $\boldsymbol{\sigma(\hat\beta)}$  \\ 
\midrule
&\\

$\beta=0.5$&$\Sigma=0.5$ & `r round(resMeanSim[1,1], 4)` & `r round(resMeanSim[1,2], 4)` & `r round(resMeanSim[1,3], 4)` &  `r round(resMeanSim[1,4], 4)` & `r round(resMeanSim[1,5], 4)` & `r round(resMeanSim[1,6], 4)`& `r round(resMeanSim[1,7], 4)` & `r round(resMeanSim[1,8], 4)` & `r round(resMeanSim[1,9], 4)`\\
&\\
&$\Sigma=5$ & `r round(resMeanSim[2,1], 4)` & `r round(resMeanSim[2,2], 4)` & `r round(resMeanSim[2,3], 4)` &  `r round(resMeanSim[2,4], 4)` & `r round(resMeanSim[2,5], 4)` & `r round(resMeanSim[2,6], 4)`& `r round(resMeanSim[2,7], 4)` & `r round(resMeanSim[2,8], 4)` & `r round(resMeanSim[2,9], 4)`\\
&\\
&$\Sigma=10$ & `r round(resMeanSim[3,1], 4)` & `r round(resMeanSim[3,2], 4)` & `r round(resMeanSim[3,3], 4)` &  `r round(resMeanSim[3,4], 4)` & `r round(resMeanSim[3,5], 4)` & `r round(resMeanSim[3,6], 4)`& `r round(resMeanSim[3,7], 4)` & `r round(resMeanSim[3,8], 4)` & `r round(resMeanSim[3,9], 4)`\\
&\\
&$\Sigma=20$ & `r round(resMeanSim[4,1], 4)` & `r round(resMeanSim[4,2], 4)` & `r round(resMeanSim[4,3], 4)` &  `r round(resMeanSim[4,4], 4)` & `r round(resMeanSim[4,5], 4)` & `r round(resMeanSim[4,6], 4)`& `r round(resMeanSim[4,7], 4)` & `r round(resMeanSim[4,8], 4)` & `r round(resMeanSim[4,9], 4)`\\
  \hline
&\\

$\beta=2$&$\Sigma=0.5$ & `r round(resMeanSim[5,1], 4)` & `r round(resMeanSim[5,2], 4)` & `r round(resMeanSim[5,3], 4)` &  `r round(resMeanSim[5,4], 4)` & `r round(resMeanSim[5,5], 4)` & `r round(resMeanSim[5,6], 4)`& `r round(resMeanSim[5,7], 4)` & `r round(resMeanSim[5,8], 4)` & `r round(resMeanSim[5,9], 4)`\\
&\\
&$\Sigma=5$ & `r round(resMeanSim[6,1], 4)` & `r round(resMeanSim[6,2], 4)` & `r round(resMeanSim[6,3], 4)` &  `r round(resMeanSim[6,4], 4)` & `r round(resMeanSim[6,5], 4)` & `r round(resMeanSim[6,6], 4)`& `r round(resMeanSim[6,7], 4)` & `r round(resMeanSim[6,8], 4)` & `r round(resMeanSim[6,9], 4)`\\
&\\
&$\Sigma=10$ & `r round(resMeanSim[7,1], 4)` & `r round(resMeanSim[7,2], 4)` & `r round(resMeanSim[7,3], 4)` &  `r round(resMeanSim[7,4], 4)` & `r round(resMeanSim[7,5], 4)` & `r round(resMeanSim[7,6], 4)`& `r round(resMeanSim[7,7], 4)` & `r round(resMeanSim[7,8], 4)` & `r round(resMeanSim[7,9], 4)`\\
&\\
&$\Sigma=20$ & `r round(resMeanSim[8,1], 4)` & `r round(resMeanSim[8,2], 4)` & `r round(resMeanSim[8,3], 4)` &  `r round(resMeanSim[8,4], 4)` & `r round(resMeanSim[8,5], 4)` & `r round(resMeanSim[8,6], 4)`& `r round(resMeanSim[8,7], 4)` & `r round(resMeanSim[8,8], 4)` & `r round(resMeanSim[8,9], 4)`\\


  \hline
&\\

$\beta=5$&$\Sigma=0.5$ & `r round(resMeanSim[9,1], 4)` & `r round(resMeanSim[9,2], 4)` & `r round(resMeanSim[9,3], 4)` &  `r round(resMeanSim[9,4], 4)` & `r round(resMeanSim[9,5], 4)` & `r round(resMeanSim[9,6], 4)`& `r round(resMeanSim[9,7], 4)` & `r round(resMeanSim[9,8], 4)` & `r round(resMeanSim[9,9], 4)`\\
&\\
&$\Sigma=5$ & `r round(resMeanSim[10,1], 4)` & `r round(resMeanSim[10,2], 4)` & `r round(resMeanSim[10,3], 4)` &  `r round(resMeanSim[10,4], 4)` & `r round(resMeanSim[10,5], 4)` & `r round(resMeanSim[10,6], 4)`& `r round(resMeanSim[10,7], 4)` & `r round(resMeanSim[10,8], 4)` & `r round(resMeanSim[10,9], 4)`\\
&\\
&$\Sigma=10$ & `r round(resMeanSim[11,1], 4)` & `r round(resMeanSim[11,2], 4)` & `r round(resMeanSim[11,3], 4)` &  `r round(resMeanSim[11,4], 4)` & `r round(resMeanSim[11,5], 4)` & `r round(resMeanSim[11,6], 4)`& `r round(resMeanSim[11,7], 4)` & `r round(resMeanSim[11,8], 4)` & `r round(resMeanSim[11,9], 4)`\\
&\\
&$\Sigma=20$ & `r round(resMeanSim[12,1], 4)` & `r round(resMeanSim[12,2], 4)` & `r round(resMeanSim[12,3], 4)` &  `r round(resMeanSim[12,4], 4)` & `r round(resMeanSim[12,5], 4)` & `r round(resMeanSim[12,6], 4)`& `r round(resMeanSim[12,7], 4)` & `r round(resMeanSim[12,8], 4)` & `r round(resMeanSim[12,9], 4)`\\


  \hline
&\\

$\beta=10$&$\Sigma=0.5$ & `r round(resMeanSim[13,1], 4)` & `r round(resMeanSim[13,2], 4)` & `r round(resMeanSim[13,3], 4)` &  `r round(resMeanSim[13,4], 4)` & `r round(resMeanSim[13,5], 4)` & `r round(resMeanSim[13,6], 4)`& `r round(resMeanSim[13,7], 4)` & `r round(resMeanSim[13,8], 4)` & `r round(resMeanSim[13,9], 4)`\\
&\\
&$\Sigma=5$ & `r round(resMeanSim[14,1], 4)` & `r round(resMeanSim[14,2], 4)` & `r round(resMeanSim[14,3], 4)` &  `r round(resMeanSim[14,4], 4)` & `r round(resMeanSim[14,5], 4)` & `r round(resMeanSim[14,6], 4)`& `r round(resMeanSim[14,7], 4)` & `r round(resMeanSim[14,8], 4)` & `r round(resMeanSim[14,9], 4)`\\
&\\
&$\Sigma=10$ & `r round(resMeanSim[15,1], 4)` & `r round(resMeanSim[15,2], 4)` & `r round(resMeanSim[15,3], 4)` &  `r round(resMeanSim[15,4], 4)` & `r round(resMeanSim[15,5], 4)` & `r round(resMeanSim[15,6], 4)`& `r round(resMeanSim[15,7], 4)` & `r round(resMeanSim[15,8], 4)` & `r round(resMeanSim[15,9], 4)`\\
&\\
&$\Sigma=20$ & `r round(resMeanSim[16,1], 4)` & `r round(resMeanSim[16,2], 4)` & `r round(resMeanSim[16,3], 4)` &  `r round(resMeanSim[16,4], 4)` & `r round(resMeanSim[16,5], 4)` & `r round(resMeanSim[16,6], 4)`& `r round(resMeanSim[16,7], 4)` & `r round(resMeanSim[16,8], 4)` & `r round(resMeanSim[16,9], 4)`\\
\bottomrule
\end{tabular}
}} 
\end{table}
...
CCDF <- function(Y, X, Z = NULL, sample_group = NULL,
  ...
  if (length(y)==11){
    for (i in 1:(n_y_unique-1)){
      ...
      if(plt){
        if(i%in%c(1,7,8,9)){
        dataPlots <- append(dataPlots,dataGlm$Y)
        }
      }
    }
    ...
    if(plt)
    {
      dataPlots <- cbind.data.frame(Y = dataPlots,X=rep(X$X1,4),G=rep(sample_group,4),Ind=rep(rep(c(1,7,8,9),each=length(X$X))))
      plts <- ggplot(dataPlots) +
          geom_boxplot(aes(x=X, y=Y, fill = G)) +
          scale_x_discrete(expand = c(0, 0.5)) +
          theme_bw()+
    ...
    return(c(betaOLS,betaMM,SEsOLS,SEsMM))
  }
}
...
simCCDF <- function (intercept=2, fixefEffects = c(.5,2,5,10), sds = c(.5,5,10,20),
                    K=10, nK=50, sims=5000){
  estimateAll <- matrix(NA, length(fixefEffects)*length(sds)*sims, 42) 
  ...
  for (fixefEffect in fixefEffects) {
    for (sdUnit in sds) {
        ...
        for(i in 1:sims){
          ...
          # CCDFRES.2 <- CCDF(Y = Y_without, X = data.frame(X=factor(X,levels = 0:1)), 
          #                   sample_group = data.frame(G=factor(G,levels = 1:10)),number_y = 11,space_y = TRUE)
...
dataPlot <- data.frame(indBeta=factor(rep(rep(1:10,2),length(names(resSimCCDF$resCCDFprime)))), 
                       Values=unlist(resSimCCDF$resCCDFprime,use.names =FALSE),Parms=rep(names(resSimCCDF$resCCDFprime),each=20),
